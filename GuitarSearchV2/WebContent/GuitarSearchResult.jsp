	  ...
	  <form action="GuitarSearch"  >
		...
		<table>
			<tbody>
		   	...
		   	<c:forEach var="oneGuitar" items="${requestScope.matchingGuitars }">
		   			<tr height="140px">
		   				 <td width="195px"><img src="images/${oneGuitar.serialNumber}.jpg" width="130px" height="130px"></td> 
		   				<td align="center" width="120px">${oneGuitar.spec.type }</td>
		   				<td align="center" width="120px">${oneGuitar.price }</td>
		   				<td align="center" width="120px">${oneGuitar.spec.numStrings }</td>
		   				<td align="center" width="120px">${oneGuitar.spec.color }</td>
		   				<td align="center" width="120px">${oneGuitar.spec.builder }</td>
		   			</tr>
		   		</c:forEach>
			</tbody>
		</table>		
